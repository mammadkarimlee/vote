...
const bentoCards = [
	{
		title: "Sorğu + BİQ",
		value: "30 bal",
		description: "Şagird və sinif nəticələri",
	},
	{
		title: "Akkreditasiya",
		value: "50 bal",
		description: "İmtahan + Portfolio",
	},
			...
			>
				...
				<section id="umumi-muddealar" className="space-y-3">
					...
					<p className="text-sm text-muted-foreground">
						PKPD sənədi pedaqoji heyətin fəaliyyətini şəffaf, ölçülə bilən və
						müqayisə edilən göstəricilər əsasında qiymətləndirmək üçün
						hazırlanmışdır.
					</p>
					<Callout variant="info" title="Qeyd">
						Bu sənəd təlimat xarakterlidir və filial rəhbərliyi tərəfindən illik
						dövrün əvvəlində elan olunur.
					</Callout>
				</section>
				...
				<section id="meqsed" className="space-y-3">
					...
					<ul className="list-disc pl-5 text-sm text-muted-foreground">
						...
						<li>
							İdarəetmə qərarları üçün obyektiv məlumat bazası formalaşdırmaq.
						</li>
					</ul>
				</section>
				...
				<section id="proses" className="space-y-3">
					...
					<p className="text-sm text-muted-foreground">
						PKPD prosesi filial rəhbərliyi, fənn koordinatorları və
						metodistlərdən ibarət komissiya tərəfindən idarə olunur.
						Qiymətləndirmə hər sorğu dövründə aparılır.
					</p>
					<Callout variant="example" title="Komissiya">
						Komissiya protokolları saxlanılır və qərar əsaslandırmaları PKPD
						nəticələrinə əlavə edilir.
					</Callout>
				</section>
				...
				<section id="balabirge" className="space-y-3">
					...
					<Tabs defaultValue="biq">
						...
						<TabsContent value="biq" className="space-y-4">
							<p className="text-sm text-muted-foreground">
								BİQ nəticələri sinif və fənn üzrə orta göstəricilərdən
								hesablanır.
							</p>
							<FormulaBox
								label="Formula"
						...
						<TabsContent value="survey" className="space-y-4">
							<p className="text-sm text-muted-foreground">
								Şagird sorğusu 1–10 şkalası ilə aparılır və 100-lük sistemə
								çevrilir.
							</p>
							<FormulaBox
								label="Formula"
				...
				<section id="ozunu" className="space-y-3">
					...
					<p className="text-sm text-muted-foreground">
						Müəllim öz fəaliyyətini 10 ballıq şkala üzrə qiymətləndirir.
						Dəyərləndirmə mətn əsaslandırması ilə birlikdə təqdim edilir.
					</p>
					<FormulaBox
						label="Qaydalar"
						formula="Özünü dəyərləndirmə balı = daxil edilən bal (0–10)"
					/>
				</section>
				...
				<section id="rehberlik" className="space-y-3">
					...
					<h2 className="text-2xl font-semibold">
						Rəhbərlik dəyərləndirməsi (10)
					</h2>
					<p className="text-sm text-muted-foreground">
						Menecer qiymətləndirməsi dərs planlaşdırılması, nizam-intizam və
						kommunikasiya üzrə aparılır.
					</p>
					<FormulaBox
						label="Qaydalar"
						formula="Rəhbərlik balı = daxil edilən bal (0–10)"
					/>
				</section>
				...
				<section id="akkreditasiya" className="space-y-3">
					...
					<h2 className="text-2xl font-semibold">
						Akkreditasiya: İmtahan (30) + Portfolio (20)
					</h2>
					<div className="grid gap-4 md:grid-cols-2">
						...
						<div className="rounded-2xl border border-border bg-card px-4 py-3 text-sm">
							...
							<p className="mt-2 text-muted-foreground">
								Təhsil pilləsi, davamiyyət, təlim və layihələr üzrə göstəricilər
								toplanır.
							</p>
						</div>
					</div>
				...
				<section id="xususi-fennler" className="space-y-3">
					...
					<Accordion type="single" collapsible>
						<AccordionItem value="drama">
							...
							<AccordionContent>
								Portfolio çəkisi artırılır, imtahan tələbi yoxdur. Fərdi
								performans göstəriciləri əlavə edilir.
							</AccordionContent>
						</AccordionItem>
						<AccordionItem value="chess">
							<AccordionTrigger>Şahmat</AccordionTrigger>
							<AccordionContent>
								Olimpiada nəticələri və layihə fəaliyyəti xüsusi bal cədvəli ilə
								qiymətləndirilir.
							</AccordionContent>
						</AccordionItem>
					</Accordion>
				...
				<section id="stimullasma" className="space-y-3">
					...
					<h2 className="text-2xl font-semibold">
						Stimullaşdırma standartları (14.1–14.6)
					</h2>
					<div className="grid gap-3 md:grid-cols-2">
				...
				<section id="qeyd" className="space-y-3">
					...
					<Callout variant="example">
						Sənədin bütün maddələri filial rəhbərliyinin qərarı ilə ildə bir
						dəfə yenilənə bilər. Nəticələr rəsmi protokolla təsdiqlənir.
					</Callout>
				</section>
			</DocLayout>
		</div>
