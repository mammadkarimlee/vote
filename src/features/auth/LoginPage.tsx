    ...
    return (
      <div className="page auth-page">
        <div className="card auth-card">
          ...
          <p>Bu istifadəçi üçün sistemdə profil yaradılmayıb. Adminə müraciət edin.</p>
    ...
    <div className="page auth-page">
      <div className="card auth-card">
        <div className="auth-header">
          ...
          <h1>Sistemə giriş</h1>
          <p>
            Login və şifrə ilə daxil olun. Adminlər email istifadə edir, səs verənlər isə sistemin
            verdiyi login ilə daxil olur.
          </p>
        </div>
