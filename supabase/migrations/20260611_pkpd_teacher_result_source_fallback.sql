...
-- summary cache has no row for that teacher yet. This RPC keeps the teacher-only
-- access contract and builds a source-backed fallback summary for the signed-in
-- teacher.
